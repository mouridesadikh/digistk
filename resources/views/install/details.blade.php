              ...
              <form class="form" id="details_form" method="post" 
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="APP_NAME" id="app_name" placeholder="Digi Stock" required>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                   ...
                   <!-- <div class="col-md-6">
                    <div class="form-group">
                        <label for="DIGI_purchase_code">DIGI Purchase Code:*</label>
                        <input type="password" name="DIGI_PURCHASE_CODE" required class="form-control" id="DIGI_purchase_code">
                    </div>
                  </div>
                  ...
                  @if($activation_key)
                            <div class="col-md-6">
                              <div class="form-group">
                                  <label for="DIGI_purchase_code">Activation Licence Code:*</label>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="MAIL_FROM_ADDRESS" name="MAIL_FROM_ADDRESS" placeholder="hello@digistock.com" required>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="MAIL_FROM_NAME" name="MAIL_FROM_NAME" placeholder="Digi Stock (Optional)">
                    </div>
                  </div>
