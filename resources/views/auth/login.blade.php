...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><h4>Demo Shops <small><i> Demos are for example purpose only, Digi Stock <u>can be used in many other similar businesses.</u></i></small></h4></div>
                <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <a href="?demo_type=superadmin" class="btn bg-red-active btn-app" data-toggle="tooltip" title="SaaS & Superadmin extension Demo">
                            ...
                            SaaS / Superadmin*</a>
                            <p class="help-block"><span class="text-danger">*</span> SaaS / Superadmin module is an Premium extension to digistock.</p>
                    </div>
                </div>
            </div>
         </div>
