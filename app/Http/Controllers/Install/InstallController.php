...
class InstallController extends Controller
{
     ...
     */
    protected $outputLog;
    protected $DIGIPersonalToken;
    protected $DIGIUsername;
    protected $DIGIProductCode;
    ...
    {
        $this->DIGIPersonalToken = config('author.app_DIGI_personal_token');
        $this->DIGIUsername = config('author.app_DIGI_username');
        $this->DIGIProductCode = config('author.app_DIGI_product_code');
        ...
        try {
            ...
            $validatedData = $request->validate(
                ...
                [
                    ...
                    #'DIGI_PURCHASE_CODE.required' => 'Envaot Purchase code is required',
            ...
            $input = $request->only(['APP_NAME', 'APP_TITLE', 'DB_HOST', 'DB_PORT', 'DB_DATABASE', 'DB_USERNAME', 'DB_PASSWORD', 'MAIL_DRIVER', 'MAIL_FROM_ADDRESS', 'MAIL_FROM_NAME', 'MAIL_HOST', 'MAIL_PORT', 'MAIL_ENCRYPTION', 'MAIL_USERNAME', 'MAIL_PASSWORD']);
